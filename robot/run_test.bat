...
set TEST_MODULES=tests

REM Use pynetworktables for SmartDashboard/NetworkTables
set PYNETWORKTABLES=False
...
:python_found
%PYTHON_BIN% -B "%~dp0\%FAKE_WPILIB_DIR%\run_test.py" --use-pynetworktables=%PYNETWORKTABLES% --test-modules="%~dp0\%TEST_MODULES%" %*
